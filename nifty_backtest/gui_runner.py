...
def run_backtest(cfg, progress_fn, results_fn):
    ...
    if mode=="single":
        ...
        GRID={
            ...
            "sl_pct_vix_r1":pf("g_sl_r1"),"sl_pct_vix_r2_calm":pf("g_sl_r2_calm"),
            "sl_pct_vix_r2_volatile":pf("g_sl_r2_vol"),"sl_pct_vix_r3":pf("g_sl_r3"),
            "sl_pct_vix_r4":pf("g_sl_r4"),"sl_buffer":pf("g_sl_buffer"),
...
def _make_params(cfg):
    ...
    return StrategyParams(
        ...
        sl_pct_vix_r1=float(cfg.get("sl_pct_vix_r1",0.40)),sl_pct_vix_r2_calm=float(cfg.get("sl_pct_vix_r2_calm",0.40)),
        sl_pct_vix_r2_volatile=float(cfg.get("sl_pct_vix_r2_volatile",0.25)),sl_pct_vix_r3=float(cfg.get("sl_pct_vix_r3",0.25)),
        sl_pct_vix_r4=float(cfg.get("sl_pct_vix_r4",0.15)),sl_buffer=float(cfg.get("sl_buffer",5.0)),
